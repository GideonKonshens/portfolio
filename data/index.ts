...
export const workExperience = [
  {
    id: 1,
    title: "Frontend Engineer Intern @ MS Azure",
  ...
  },
  {
    ...
    desc: "Led the dev of a mobile app for a client, from initial concept to deployment on app stores. {-Jailbreaker-} ",
    className: "md:col-span-2", // change to md:col-span-2
    thumbnail: "/exp3.svg",
  },
  {
    ...
    desc: "Developed and maintained user-facing features using modern frontend technologies, plus a bit of Backend.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
